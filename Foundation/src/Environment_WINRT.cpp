...
void EnvironmentImpl::nodeIdImpl(NodeId& id)
{
	...
	packageSpecificToken = Windows::System::Profile::HardwareIdentification::GetPackageSpecificToken(nullptr);

	Windows::Storage::Streams::IBuffer ^ buffer = packageSpecificToken->Id;

	// TODO Copy this to the id buffer 
}
